...
description: Use when improving an existing feature of OpManager Plus. Takes an enhancement idea through current-state analysis, cross-module analysis, competitive analysis, findings, deliverable generation (PPT/PDF/DOCX), and Lovable wireframe prompt. Use when the PM says "improve", "enhance", or describes a gap in something that already exists.
