...
2. [context/product-context.md](pm-shared/context/product-context.md) — product DNA
...
2. Rebuild `analysis.html`: `python "<resolved shared parent>/pm-shared/scripts/build_report.py" "[slug]/"`.
...
2. Render the flowchart with Archify (`<resolved shared parent>/archify/bin/archify.mjs`) to `architecture.html`
